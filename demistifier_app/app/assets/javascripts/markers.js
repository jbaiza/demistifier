...
var timeRange = 10 * MINUTES;

var dataEndpoint = 'institutions.csv'; //'https://demistifier.ngrok.io/institutions.csv';
///////////////////////////////////////////////////////////////////////////
            ...
            for (let i = 1, l = parsed.length; i < l; i++) {
                ...
                feature = {
                    ...
                    'properties': {
                        ...
                        'email': row[5],
                        'type': row[4],
                        'mailto': '/institutions/' + row[13] + '/institution_program_languages/' + row[14],
                        'language': row[10],
                        'startingAge': row[11],
                        'queueSize': row[12],
